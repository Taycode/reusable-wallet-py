...
class AssetManager:
    @staticmethod
    def create_asset(user_id: str, symbol: str, session: Session) -> Asset:
    ...
    @staticmethod
    def fetch_user_asset(user_id: str, symbol: str, session: Session) -> Asset:
        """Fetch a user asset.
    ...
    @staticmethod
    def fetch_asset_by_id(asset_id: str, session: Session) -> Asset:
